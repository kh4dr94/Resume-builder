    ...
    experience: () =>
      filledExperience.length > 0 ? (
        <div key="experience" className="mb-8">
          <h2 className="text-[10px] font-semibold uppercase tracking-[3px] mb-5" style={{ color: accent || '#9ca3af' }}>
            Experience
          </h2>
    ...
    skills: () =>
      filledSkills.length > 0 ? (
        <div key="skills" className="mb-8">
          <h2 className="text-[10px] font-semibold uppercase tracking-[3px] mb-4" style={{ color: accent || '#9ca3af' }}>
            Skills
          </h2>
  ...
  return (
    ...
    >
      ...
      <div className="mb-10">
        ...
        {personalInfo.title && (
          <p className="text-[13px] font-normal tracking-wide mb-5" style={{ color: accent || '#9ca3af' }}>
            {personalInfo.title}
          </p>
        )}
